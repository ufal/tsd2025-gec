...
def main(config_filename: str):
    ...
    if not ERRORS_FROM_FILE:
        ...
        gel = None # deprecated – GenereteErrorLine was replaced by ErrorGenerator
    ...
    _status_optimizer = model_checkpoint_optimizer.checkpoint.restore(mybackup.manager.latest_checkpoint)
    print("STATUS:", status)
    ...
    with strategy.scope():
        if USE_F16 and MODEL_TYPE == "Transformer":
