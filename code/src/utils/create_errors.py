...
# For normal usage (when methods are imported from elsewhere),
# keep the relative imports below:
from .edit import Edit
from .errors import ERRORS

# If you run this file directly for quick testing (e.g. `python main.py`),
# uncomment the absolute imports below:
# from edit import Edit
# from errors import ERRORS
...
# The following main() function is kept only for standalone testing and debugging. 
# In normal usage this module is imported and its methods are called directly, 
# so __main__ is not executed.
#
# To try it manually from terminal, uncomment the code below:
#
# def main(args):
